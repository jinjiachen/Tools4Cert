...
values=[
        ...
        ("15.101","Spillage Test","As specified in standard","EC2969, EC2834, EC2385","P/F/NA"),
        ...
        ("19.4","Operation with any defect","As speficied in standard","EC5936, EC5865","P/F/NA"),
        ("19.5","Short-circuited the Sheath and N conductor","As specified in standard","--","P/F/NA"),
        ("19.6","Abnormal Operation-PTC","As specified in standard","EC5936, EC5865, EC3102","P/F/NA"),
        ("19.7","Locking Test for the Motor","Refer to table below","EC5132, EC3102, EC2834, EC5800, EC2743","P/F/NA"),
        ("19.8","Three phase motor","Refer to table below","EC5865, EC5936","P/F/NA"),
        ("19.10","Tests for Series Motors","As specified in standard","EC5865, EC5936","P/F/NA"),
        ...
        ("19.12","Tests for Miniature Fuse-link","Refer to table below","EC5865, EC5936, EC5800","P/F/NA"),
        ...
        ("20.1","Stability Test","(   ) inclined","EC4261","P/F/NA"),
        ("20.2","Mechanical Hazard","As specified in standard","EC2162","P/F/NA"),
        ("21.1","Spring Hammer Test","As specified in standard","EC5553","P/F/NA"),
        ("Annex EE","Pressure Tests","Refer to table below","EC5768","P/F/NA"),
        ("21.2","Strength of Solid Insulation & Viberation Test","As specified in standard","--","P/F/NA"),
        ("22.3","Undue Strain Test on Socket-Outlet","As specified in standard","EC5076","P/F/NA"),
        ("22.5","Plug Discharge Test","Refer to table below","EC2567, EC3175, EC5132","P/F/NA"),
        ("22.6","Water Leakage Test","As specified in standard","EC2615","P/F/NA"),
#        ("22.11","Stability of Non-detachable Parts","Refer to table below","EC2092","P/F/NA"),
        ("22.12","Pull Test","(   )N","EC2092","P/F/NA"),
        ("22.16","Cord Reel Abrasion Test","As specified in standard","EC2285, EC2384","P/F/NA"),
        ("22.24","Bare Heating Elements","As specified in standard","--","P/F/NA"),
        ("22.32","Ageing Test of Rubber & Test of Ceramic Material","As specified in standard","--","P/F/NA"),
        ("22.42","Protective Impedance","As specified in standard","--","P/F/NA"),
        ("22.47","Water Mains Pressure Test","(   )MPa, 5mins, No Leakage","EC2468, EC3667","P/F/NA"),
        ("22.57","UV-C Radiation","As specified in standard","--","P/F/NA"),
        ...
        ("22.108","Vacuum Pressure Impulses for Storage Tanks","(   )MPa, 15mins, No Deformation","EC5768","P/F/NA"),
        ("22.110","Operation of Non-self-resetting thermal cut-outs","As specified in standard","--","P/F/NA"),
        ("22.127-22.129","Irradiance Limit Test","As specified in standard","EC5912, EC4255","P/F/NA"),
        ("23.3","Internal Wiring Flexing Test","(\t) times for the flexing conductors","EC2285","P/F/NA"),
        ("23.5","Insulation of Internal Wiring Test","2000 V, 15 minutes","EC2834","P/F/NA"),
        ("24.5","Capacitor voltage","Rated voltage:\nMeasured voltage:","EC6081, EC4937, EC5132","P/F/NA"),
        ...
        ("31","Salt Mist Test","As specified in standard","--","P/F/NA"),
        ("32.101","UV-C Irradiance Test","Measured UV-C spectral irradiance: (\t)uW/cm2","--","P/F/NA"),
        ("Annex N","Proof Tracking Test","Refer to table below","EC2071","P/F/NA"),
#        ("Annex B","Appliance Powered by Rechargeable Batteries","--","P/F/NA"),
#        ("Annex D","Motor with Thermal Protectors","--","P/F/NA"),
#        ("Annex H","Switch Endurance Test","--","P/F/NA"),
#        ("Annex I","Motors having basic insulation that is inadequate for the rated voltage of the appliance","--","P/F/NA"),
#        ("Annex EE","Pressure Tests","--","P/F/NA"),
        ("Annex FF","Leakage Simulation Tests","Refer to table below","EC5382, EC6022, EC6023","P/F/NA"),
#        ("Annex GG","Refrigerant Charge","--","P/F/NA")
        ]
...
while True:
    try:
        ...
        if sel=="2":
            ...
            ### transfer the list from string to int, to sort
            j=0 
            for i in selection_sort:
                selection_sort[j]=int(i)
                j=j+1
            selection_sort.sort()

            ### transfer the list from int to string to output the testing clauses
            for i in selection_sort:
                i=str(i)
                Check(i)
